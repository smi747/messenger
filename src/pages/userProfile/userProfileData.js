...
const userProfileData = {name: "Иван", data: [{name: "Почта", value: "pochta@yandex.ru", name_: "email"}, {name: "Логин", value: "ivanivanov", name_: "login"}, {name: "Имя", value: "Иван", name_: "second_name"}, {name: "Фамилия", value: "Иванов", name_: "first_name"}, {name: "Имя в чате", value: "Иван", name_: "display_name"}, {name: "Телефон", value: "8 800 000 00 00", name_: "phone"}]};
...
export default class userProfile {
    ...
    render() {
        const compiledTemplate = Handlebars.compile(userPrfile_)({userProfileData: userProfileData, state: this.state});
